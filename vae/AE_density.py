...
val_loss_plot = []
test_loss_plot = []
# data_type = '_all_a_density_AE'  # _b_a_density_ratio , _only_b_a  _a_a_density_AE

# type = ['_a_a_density_AE', '_b_a_density_AE', '_d_a_density_AE', '_e_a_density_AE', '_f_a_density_AE', '_ae_a_density_AE', '_ef_a_density_AE', '_all_a_density_AE']
type = ['_m_a_density_AE']
...
def calculation_latent(data_type):
...
def main():
    ...
    # data_processing()
    kl_ratio_list = [0.01, 0.10, 1.00, 10.00, 100.00]
    # kl_ratio_list = [0.01, 0.10, 1.00, 100]
    # kl_ratio_list = [10.00]
    for k in type:
